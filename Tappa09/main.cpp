...
class Scene
{
    ...
    private:
        ...
        void draw_cue(glm::mat4 parent_mm)
        {
            ...
            draw_mesh(cylinder, mm, cue_mat, "phong");
        }
...
int main(int argc, char* argv[])
{
    ...
    fcg::Shaders shaders;
    shaders.add("phong","../Tappa09/vertex_shader.vert","../Tappa09/fragment_phong.frag");
    shaders.add("flat","../Tappa09/vertex_shader.vert","../Tappa09/fragment_flat.frag");
    shaders.use("flat");
    Scene scene (shaders);
